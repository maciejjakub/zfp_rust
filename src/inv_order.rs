...
pub fn inv_order1<I: OrderInt>(input_list: [I; 4]) -> [I; 4] {
...
pub fn inv_order2<I: OrderInt>(input_list: [I; 16]) -> [I; 16] {
...
pub fn inv_order3<I: OrderInt>(input_list: [I; 64]) -> [I; 64] {
...
mod tests {
    ...
    fn i8_test() {
        ...
        let output = super::inv_order1(input);
    ...
    #[test]
    fn i32_test2d() {
        let input: [i32; 16] = [0, 11, 44, 55, 22, 88, 66, 99, 33, 122, 100, 77, 133, 111, 144, 155];
        let output = super::inv_order2(input);
        assert_eq!(output, [0, 11, 22, 33, 44, 55, 66, 77, 88, 99, 100, 111, 122, 133, 144, 155]);
    }
    #[test]
    fn i32_test3d() {
        let input: [i32; 64] = [
        ...
        let output = super::inv_order3(input);
